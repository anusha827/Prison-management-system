...
<body>
<form class="form-horizontal" action="a_upd_dbms.php" method="post">	
<fieldset>

<!-- Form Name -->
<legend>Update Admin Details</legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Name: </label>  
  <div class="col-md-4">
  <input id="textinput" name="noinput" type="text" placeholder="eg: Anusha S" class="form-control input-md">
