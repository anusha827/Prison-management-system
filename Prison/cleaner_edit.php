...
<body>
<form class="form-horizontal" action="c_upd_dbms.php" method="post">	
<fieldset>

<!-- Form Name -->
<legend>Update Cleaner Details</legend>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="nameinput" type="text" placeholder="eg: Anusha S" class="form-control input-md">
