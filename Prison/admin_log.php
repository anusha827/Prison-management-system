...
<!-- Form Name -->
<legend style = 'background-color:#5D6D7E;color:white;font-size:5rem;text-align:center;'>Admin Login Portal</legend>

<!-- Text input-->
<div class="form-group" style ='font-size:2rem;' >
  <label class="col-md-4 control-label" for="textinput">Username: </label>  
  <div class="col-md-4">
  <input id="textinput" name="textinput" type="text" placeholder="example:Anusha" class="form-control input-md">
