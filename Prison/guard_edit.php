...
<body>
<form class="form-horizontal" action="g_upd_dbms.php" method="post">	
<fieldset>

<!-- Form Name -->
<legend>Update Guard deatils</legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">eGuard Name: </label>  
  <div class="col-md-4">
  <input id="textinput" name="nameinput" type="text" placeholder="eg: Anusha" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="addinput" type="text" placeholder="eg: Bangalore" class="form-control input-md">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="textinput" name="password" type="text" placeholder="eg: abc" class="form-control input-md">
