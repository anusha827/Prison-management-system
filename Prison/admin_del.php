...
<body>
<form class="form-horizontal" action="a_del_dbms.php" method="post">	
<fieldset>

<!-- Form Name -->
<legend>Delete Admin Details</legend>

<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Admin Name </label>  
  <div class="col-md-4">
  <input id="textinput" name="input" type="text" placeholder="eg: Anusha" class="form-control input-md">
